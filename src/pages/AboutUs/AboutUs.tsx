            ...
            <div className="relative">
              ...
              <div className="flex mt-[-28%]">
                ...
                <p className="pt-[22%] pr-[4%] z-[3] text-2xl font-medium text-white font-montserrat">
                  Welcome to the Official Wolfoo World website. We have created
                  a world of Wolfoo with a primary goal to engage families with
              ...
              <div className="flex">
                <p className=" pt-[5%] pl-[5%] text-2xl text-white font-montserrat">
                  ...
                  - 8 by creating funny stories with 2D animations. Children get
                  to learn good habits, safety tips, colors, numbers, good
                  manners, healthy habits, professions for kids, and more by
                  enjoying our videos
                </p>
